...
export const ChannelPricingGrid: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-stone-50 to-amber-50/20 p-6">
      ...
      {/* Main Content Card */}
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-slate-200 dark:border-gray-700">
        {/* Reservation Type Section */}
        <div className="border-b border-slate-200 dark:border-gray-700 px-6 py-5 bg-gradient-to-r from-slate-50 to-stone-50 dark:from-gray-700 dark:to-gray-800">
        ...
        <div className="p-6 border-b border-slate-200 dark:border-gray-700">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-5">
            <div className="bg-gradient-to-br from-slate-50 to-slate-100 dark:from-gray-700 dark:to-gray-800 rounded-2xl p-5 border border-slate-300 dark:border-gray-600 shadow-sm hover:shadow-lg transition-shadow">
