...
export const ChannelPricingPage: React.FC = () => {
  ...
  const [editingPricing, setEditingPricing] = useState<ChannelPricing | null>(
    null
  );
      ...
      <div className="flex items-center justify-between mb-6 pb-4 border-b border-slate-200 dark:border-gray-700">
        <div>
          ...
          <p className="text-slate-600 dark:text-gray-300 mt-1 font-medium">
            Set pricing rules for different booking channels
          </p>
        </div>
        <Button
        ...
        <div className="space-y-4">
          ...
          <Select
            ...
            onChange={(e) =>
              setFormData({
                ...formData,
                modifierType: e.target.value as "percentage" | "fixed",
              })
            }
            options={[
