      ...
      <Card>
        <div className="flex flex-col gap-6">
          ...
          <div className="flex flex-wrap gap-2">
            {STATUS_FILTERS.map(({ value, label, tone, description }) => {
              ...
              return (
                ...
                >
                  <span>{label}</span>
                  <span className="rounded-full bg-white/70 dark:bg-gray-800/70 px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider text-slate-600 dark:text-gray-300">
                    {count}
                  </span>
                </button>
              );
          ...
          <div className="grid grid-cols-2 gap-3 md:grid-cols-4">
            ...
            <div className="rounded-lg border border-slate-200 dark:border-gray-700 bg-white dark:bg-gray-800 px-4 py-3 shadow-sm">
            ...
            <div className="col-span-2 rounded-lg border border-slate-200 dark:border-gray-700 bg-white dark:bg-gray-800 px-4 py-3 shadow-sm md:col-span-2">
              <p className="text-xs font-semibold uppercase tracking-wide text-slate-500 dark:text-gray-400">
                Projected revenue
              </p>
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              ...
              <div className="rounded-lg border border-slate-200 dark:border-gray-700 bg-white dark:bg-gray-800 px-4 py-3 shadow-sm">
                ...
                <div className="mt-1 space-y-1 text-sm text-slate-900 dark:text-gray-100">
                  <p>
