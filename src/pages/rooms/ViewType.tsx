...
export const ViewType: React.FC = () => {
  ...
  const [editingViewType, setEditingViewType] = useState<ViewTypeEntity | null>(
    null
  );
      ...
      <div className="flex items-center justify-between mb-6 pb-4 border-b border-slate-200">
        <div>
          ...
          <p className="text-slate-600 dark:text-gray-300 mt-1 font-medium">
            Manage room view types and pricing
          </p>
        </div>
        <Button
          aria-label="Add view type"
          title="Add view type"
          onClick={handleAdd}
        >
        ...
        <div className="space-y-4">
          ...
          <Input
            ...
            onChange={(e) =>
              setFormData({
                ...formData,
                priceDifference: parseFloat(e.target.value) || 0,
              })
            }
            step="0.01"
          />
