...
export const StayTypes: React.FC = () => {
  ...
  const columns = [
    { key: "name", header: "Name" },
    {
      key: "hours",
      header: "Hours",
      render: (st: StayType) => st.hours || "-",
    },
    {
      key: "rateMultiplier",
      header: "Rate Multiplier",
      render: (st: StayType) => `${st.rateMultiplier}x`,
    },
      ...
      <div className="flex items-center justify-between mb-6 pb-4 border-b border-gray-200 dark:border-gray-700">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-300 mt-1 font-medium">
            Configure different stay duration options
          </p>
        </div>
        <Button
          aria-label="Add stay type"
          title="Add stay type"
          onClick={handleAdd}
        >
