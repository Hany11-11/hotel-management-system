...
export const RoomsOverview: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="hover-lift premium-calendar-card">
        <div className="mb-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-xl font-bold text-slate-900 dark:text-gray-100 min-w-[180px] text-center px-4">
        ...
        >
          <div className="inline-block min-w-full">
            ...
            <div className="flex border-b-2 border-slate-300 bg-gradient-to-r from-slate-50 to-slate-100 sticky top-0 z-[2]">
              <div className="w-[180px] flex-shrink-0 p-3 font-bold text-slate-700 dark:text-gray-300 border-r-2 border-slate-300 dark:border-gray-600 bg-white dark:bg-gray-800 sticky left-0 z-[3]">
                Room
              </div>
            ...
            {filteredRooms.map((room) => {
              ...
              return (
                ...
                >
                  <div className="w-[180px] flex-shrink-0 p-3 border-r-2 border-slate-300 dark:border-gray-600 bg-white dark:bg-gray-800 sticky left-0 z-[3]">
                    <div className="font-bold text-slate-900 dark:text-gray-100 text-base">
                      {room.roomNumber}
                    </div>
      ...
      <Card className="hover-lift premium-calendar-card">
        <h3 className="text-xl font-bold text-slate-900 dark:text-gray-100 mb-6 flex items-center">
        ...
        >
          {(() => {
            ...
            const typeStyles: Record<string, string> = {
              VIP: "bg-gradient-to-r from-yellow-400 to-yellow-500 text-yellow-900 dark:from-yellow-600 dark:to-yellow-700 dark:text-yellow-100",
              Regular:
            ...
            return (
              <div className="space-y-6">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-slate-900 dark:text-gray-100 mb-4 pb-2 border-b border-slate-200 dark:border-gray-700">
                    Customer Information
                  </h3>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <p className="text-base text-slate-900 dark:text-gray-100 mt-1">
                        {customer?.name || "N/A"}
                      </p>
                    </div>
                    <div>
