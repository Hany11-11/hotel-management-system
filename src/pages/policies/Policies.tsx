      ...
      <div className="flex items-center justify-between mb-6 pb-4 border-b border-slate-200">
        <div>
          ...
          <p className="text-slate-600 mt-1 font-medium">
            Manage hotel policies and rules
          </p>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-3 py-2 border border-slate-300 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-100 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
              rows={4}
              required
            />
          </div>
