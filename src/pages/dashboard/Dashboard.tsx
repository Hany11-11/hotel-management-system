            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {filteredRooms.map((room) => {
                ...
                return (
                  <div
                    key={room.id}
                    className="p-4 border dark:border-gray-700 rounded-lg hover:shadow-md transition-shadow dark:bg-gray-800"
                  >
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 pb-4 border-b">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div className="px-4 py-1 bg-amber-50 dark:bg-amber-900/30 border border-amber-200 dark:border-amber-700 rounded-lg">
            ...
            <div className="overflow-x-auto">
              <table className="w-full border-collapse">
                <thead>
                  <tr>
                    <th className="sticky left-0 z-10 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 px-4 py-3 text-left font-semibold text-gray-700 dark:text-gray-300 min-w-[120px] shadow-sm">
                      Room
                    </th>
                    {visibleCalendarDays.map((day) => (
                      <th
                        key={day.date}
                        className="border border-gray-200 dark:border-gray-700 px-3 py-2 text-center bg-gray-50 dark:bg-gray-700 min-w-[80px]"
                      >
                  ...
                  {state.rooms
                    ...
                    .map((room) => {
                      ...
                      return (
                        ...
                        >
                          <td className="sticky left-0 z-10 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 px-4 py-3 shadow-sm">
