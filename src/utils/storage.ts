...
export const storageKeys = {
  ...
  eventPackages: `${STORAGE_PREFIX}eventPackages`,
  additionalServices: `${STORAGE_PREFIX}additionalServices`,
  halls: `${STORAGE_PREFIX}halls`,
  eventInvoices: `${STORAGE_PREFIX}eventInvoices`,
  eventBookings: `${STORAGE_PREFIX}eventBookings`,
};
