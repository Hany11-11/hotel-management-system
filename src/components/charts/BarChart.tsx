...
const CustomTooltip = ({ active, payload, label }: any) => {
  if (active && payload && payload.length) {
    return (
      <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-xl border border-slate-200 dark:border-gray-700 backdrop-blur-sm">
        <p className="font-bold text-slate-900 dark:text-gray-100 mb-2">
          {label}
        </p>
...
export const BarChart: React.FC<BarChartProps> = ({
  ...
  return (
    <div className="w-full animate-fade-in">
      {title && (
        <h4 className="text-lg font-bold text-slate-900 dark:text-gray-100 mb-6 flex items-center">
