    ...
    <div className="fixed inset-0 z-50 overflow-y-auto animate-fade-in">
      <div className="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
        <div
          ...
          onClick={onClose}
        />
        <div className="inline-block align-bottom premium-card text-left overflow-hidden shadow-premium-lg transform transition-all duration-300 scale-100 animate-fade-in sm:my-8 sm:align-middle sm:max-w-lg sm:w-full bg-white dark:bg-gray-800 rounded-lg">
          ...
          {footer && (
            <div className="bg-gradient-to-r from-slate-50 to-stone-50 dark:from-gray-800 dark:to-gray-800 px-6 py-4 sm:px-6 sm:flex sm:flex-row-reverse border-t border-slate-200 dark:border-gray-700">
              {footer}
            </div>
          )}
        </div>
