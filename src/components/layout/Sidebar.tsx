...
export const Sidebar: React.FC = () => {
  ...
  return (
    <div
      className={`bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950 border-r border-gray-700 dark:border-gray-600 h-screen fixed left-0 top-0 transition-all duration-300 shadow-xl z-40 ${
